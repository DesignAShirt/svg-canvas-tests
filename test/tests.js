describe('in and out', function() {
  ...
  describe('data uris', function () {
    ...
    it('datauri png', function(done) {
      renderUrl(png, done);
    });

    it('datauri svg', function(done) {
      renderUrl(svg, done);
    });
  });
